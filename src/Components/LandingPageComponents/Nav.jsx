      ...
      <div className="lg:block hidden ">
        <div className="fixed top-0 font-poppins font-semibold w-full bg-[#87ACA3]/[0.4] 2xl:px-[10rem] xl:px-[8rem] lg:px-10 py-3 z-40 rounded-b-lg flex justify-between items-center">
          ...
          <span className="flex text-white w-[29rem] justify-between items-center text-sm">
            <Link
              activeClass="active"
              className="cursor-pointer hover:text-[#2B7C85] transition-all duration-3000"
              to="works"
              spy={true}
              smooth={true}
              offset={-68}
            ...
            <button
              ...
              className="px-8 py-[0.7rem] rounded bg-[#009186] hover:text-[#2B7C85] hover:bg-white transition-all duration-3000"
            >
              <Link
      ...
      <div className="fixed top-0 px-2 xss:px-4 xs:px-6 sm:px-10 md:px-8 font-poppins w-full bg-[#87ACA3]/[0.4] lg:hidden py-5 flex z-[70] rounded-b-lg justify-between">
        ...
        <span className="flex">
          <button
            ...
            className="sm:px-5 py-[0.5rem] px-2 xss:py-[0.5rem] xss:px-4 xs:py-[0.7rem] xs:px-7 sm:py-[0.7rem] text-[0.7rem] xs:text-[0.8rem] sm:text-sm md:text-base rounded-[8px] bg-[#009186] text-white mr-4"
          >
            Create Account
          </button>
          <HiMenu
      ...
      {bool ? (
        <div className="h-[15rem] lg:hidden w-full flex flex-col text-sm sm:text-base items-center justify-evenly text-white bg-[#87ACA3] text-light z-50 fixed top-[4rem] rounded-b-lg">
          <Link
            ...
            duration={1000}
            onClick={() => setbool(!bool)}
            className="nav-link hover:text-[#2B7C85] transition-all duration-3000"
          >
            How it works
          </Link>
          <Link
